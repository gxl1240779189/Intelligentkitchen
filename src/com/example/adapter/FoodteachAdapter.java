...
public class FoodteachAdapter extends ArrayAdapter<Foodcontent> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			...
			viewholder.teachimage=(ImageView) view.findViewById(R.id.teach_image);
			viewholder.teachtext=(TextView) view.findViewById(R.id.teach_text);
		...
		if(!item.imagelink.equals("noimagelink"))
		{
			viewholder.teachimage.setVisibility(View.VISIBLE);
		     imageLoader.displayImage(item.imagelink,
				viewholder.teachimage, options);
		}
