...
/**
 * 此类在Onekeyshare中并无用途，只是在Socialization中考虑到耦合度，需要通过反射的方式操作Onekeyshare， 而原先的
 * {@link ShareContentCustomizeCallback}无法完成此需求，故创建本类，以供外部设置操作回调。
 * 
 * @author Brook
 */
public class ReflectableShareContentCustomizeCallback implements
